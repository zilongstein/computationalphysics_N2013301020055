...
c1=Adi_drag_cannon(flight_state(0,0,800*2**0.5*math.cos(45*math.pi/180),800*2**0.5*math.sin(45*math.pi/180)))
c1.shot()
c1.show_trace()
plt.plot(x,y,'g',label=r'Adi $\theta=45^\circ$')
plt.legend(loc='best',prop={'size':10},frameon=False)
c1_final=x[-1]
d1=Drag_cannon(flight_state(0,0,800*2**0.5*math.cos(45*math.pi/180),800*2**0.5*math.sin(45*math.pi/180)))
d1.shot()
d1.show_trace()
...
c2=Adi_drag_cannon(flight_state(0,0,800*2**0.5*math.cos(60*math.pi/180),800*2**0.5*math.sin(60*math.pi/180)))
c2.shot()
c2.show_trace()
...
c3=Adi_drag_cannon(flight_state(0,0,800*2**0.5*math.cos(30*math.pi/180),800*2**0.5*math.sin(30*math.pi/180)))
c3.shot()
c3.show_trace()
...
c4=Adi_drag_cannon(flight_state(0,0,800*2**0.5*math.cos(37.5*math.pi/180),800*2**0.5*math.sin(37.5*math.pi/180)))
c4.shot()
c4.show_trace()
...
c5=Adi_drag_cannon(flight_state(0,0,800*2**0.5*math.cos(52.5*math.pi/180),800*2**0.5*math.sin(52.5*math.pi/180)))
c5.shot()
c5.show_trace()
